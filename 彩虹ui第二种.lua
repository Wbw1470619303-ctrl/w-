...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://135318100172213"
...
if theme == 'dark' then
    ...
    beijingColor = Color3.fromRGB(25, 25, 25)
      ...
      DropShadow.Image = "rbxassetid://135318100172213" --背景
...
Open.Size = UDim2.new(0.5, 2, 0.5, 2)
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://135318100172213"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://135318100172213" or "rbxassetid://135318100172213" --开关的图
end)
...
---------------分割线-------------------------------分割线-------------------------------分割线----------------
        ...
        function section:Label(text)
          ...
          function section.Toggle(section, text, flag, enabled, callback)
            ...
            ToggleModule.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
